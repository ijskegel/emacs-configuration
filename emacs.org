...
- [ ] setup embark
- [ ] use [[https://protesilaos.com/emacs/beframe][beframed]] for multi-frame workflow; 1 frame for GTD and documentation, other frames for projects etc. What is the benefit over using project.el buffer list (C-x p b)?
